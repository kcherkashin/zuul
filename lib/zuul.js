...
module.exports = function(config) {
    ...
    function bouncer_active() {
        ...
        expand_browsers(config.browsers || [], function(err, browsers) {
            ...
            // so we need to manage running each browser manually?
            // because of the engine.io client request/responses
            // or we can add a browser key to the url

            // init the cloud browser
            // open the requested url
            // wait for browser finish from control
            // report test status
